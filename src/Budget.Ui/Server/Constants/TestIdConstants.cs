namespace Budget.Ui.Server.Constants;

public static class TestIdConstants
{
    public const string HeadingCurrentMonth = "heading_current_month";
    public const string PreviousMonthButton = "previous_month_button";
