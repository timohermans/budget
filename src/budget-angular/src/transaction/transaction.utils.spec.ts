...
import { isFixedIncome, isFromOtherParty, isIncome, toDate, toIsoWeekNumber } from './transaction.utils';
...
describe('transaction.utils', () => {
    ...
    ])('converts $dateStr to ISO week number $weekNumberExpected', ({ dateStr, weekNumberExpected }) => {
    ...
    describe('isFromOtherParty', () => {
        ...
        ])('marks $otherIban as $expected other party when owned ibans are $ownedIbans', ({ otherIban, ownedIbans, expected }) => {
            const transaction: TransactionApiModel = {
                Amount: 10,
                DateTransaction: '2025-12-12',
                Iban: 'OWNED01',
    ...
    describe('isFixedIncome', () => {
        it.each([
            { description: 'salaris', amount: 3000, cashbackDate: undefined, code: 'sb', otherIban: 'OTHER01', ownedIbans: ['OWNED01'], expected: true },
            { description: 'kinderopvang', amount: 200, cashbackDate: undefined, code: 'cb', otherIban: 'OTHER01', ownedIbans: ['OWNED01'], expected: true },
            { description: 'kerst buffer', amount: 600, cashbackDate: undefined, code: 'tb', otherIban: 'OWNED02', ownedIbans: ['OWNED01', 'OWNED02'], expected: false },
            { description: 'essent teruggave', amount: 144, cashbackDate: '2025-12-01', code: 'cb', otherIban: 'OTHER01', ownedIbans: ['OWNED01'], expected: false },
            { description: 'mcdonalds', amount: -20, cashbackDate: undefined, code: 'ba', otherIban: 'OTHER01', ownedIbans: ['OWNED01'], expected: false },
            ...
            {amount, cashbackDate, otherIban, ownedIbans, expected}
        ) => {
const transaction: TransactionApiModel = {
                Amount: amount,
                DateTransaction: '2025-12-12',
